...
// Get our error log transient into variable
$errorItems = get_option( 'error_report' );
            ...
            switch ($tab) {
                    ...
                    case 'status' :
                        ...
                        <div class="error">
                            <h3>Errors Report</h3>
                            <div class="line"></div>
                            <p><strong>Recorded Errors:</strong>
                            <?php 
                                if( !empty( $errorItems ) && isset( $errorItems ) ) { 
                                    // If we have errors, foreach over them and output to admin view
                                    foreach( $errorItems as $errorItem ) { ?>
                                        <p><strong>User info: </strong><?php echo json_encode( $errorItem['user_info'] ); ?></p>
                                        <p><strong>User status: </strong><?php echo $errorItem['user_status'] ?></p>
                                        <p><strong>Date of Error: </strong><?php echo $errorItem['error_date'] ?></p>
                                        <p><strong>Error Message: </strong><?php echo $errorItem['error_message'] ?></p>
                                        <div class="line"></div>
                                <?php }
