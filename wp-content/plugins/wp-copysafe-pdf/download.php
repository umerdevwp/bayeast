    ...
    <tr>
      ...
      <table border="0" cellpadding="10" cellspacing="0" style="BORDER: 1px solid #B1B1B1;; border-collapse:collapse" width="100%">
          <tr>
            ...
            <td align="center" class="textGray">Secure solutions for video, documents and web pages.</td>
          </tr>
        </table>
      </td>
    </tr>
              ...
              <tr>
                ...
                <div class="text" dir="ltr">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="text" align="center"> <b>Download the ArtisBrowser</b><br>
      <script type="text/javascript">
			if (newmessage == '1') {
      			document.write("<table width='95%' border='0' cellspacing='0' cellpadding='0'><tr><td class='text' align='left' style='text-align: justify'><font color='#FF3333'>Your version of web browser no longer supports real plugins, so if you have already installed the Copysafe PDF Reader and keep returning here, that is why. So to view the protected PDF on this site you can install the ArtisBrowser which does support real plugins; then navigate to the protected PDF that you wanted.</font></td></tr></table><br><br>");
			}
      </script>
                                                ...
                                                <td width="100%" align="center"> 
                                                  <table width="80%" border="0" cellspacing="0" cellpadding="3">
                                                    <tr> 
                                                      ...
                                                      <td class="text" nowrap align="left">&nbsp;&nbsp;ArtisBrowser&nbsp;&nbsp; 
                                                      </td>
                                                      <td class="text" nowrap> 
                                                        &nbsp;<a href="http://images.artistscope.com/download/ASPS_Browser_install.zip"><u>Download 
                                                        Now</u></a>&nbsp;</td>
                                                      <td class="text" nowrap>&nbsp;&nbsp;59 
                                                        Mb &nbsp;&nbsp;</td>
                                                    </tr>
                                                  </table>
                                                </td>
                                          ...
                                          <br>
                                          * NOTE: the ArtisBrowser includes all 
                                          CopySafe plugins.<br>
                                          <br>
                                        </div>
                                            <table align="center" width="95%" border="0" cellspacing="0" cellpadding="0">
                                              <tr> 
                                                <td class="text" align="left" style="text-align: justify"> 
                                                  ...
                                                  with all <a target="_blank" href="ArtisBrowser_Licence.pdf">terms 
                                                  of use</a>.</td>
                                              </tr>
                                            </table>
                  </div></td>
                                    ...
                                    <table class="text" border="0" cellpadding="10" cellspacing="0" width="100%">
                                      <tr> 
                                        <td width="200" dir="ltr"><b>Related Links</b><br>
                                          <br>
                                      <a href="https://artistscope.com/copysafe_pdf_protection.asp">CopySafe 
                                      PDF</a> <br>
                                          <br>
                                      The CopySafe PDF Reader and ArtisBrowser 
                                      are a free download to everyone.<br>
