...
$additionalCost  = get_field('additional_pricing_information');
$registerLink = get_field('register_link')
?>

<?php if ( ! empty( $cost ) ) : ?>
	<div class="tribe-events-pricing-cost">

			<div class="label"><?php esc_html_e( 'Pricing', 'the-events-calendar' ) ?></div>
			<p><?php esc_html_e( $cost ); ?></p>


		<?php if ($additionalCost) : ?>
			<p><?php echo $additionalCost; ?></p>
		<?php endif; ?>
	</div>
<?php endif ?>

<?php if ($registerLink) : ?>
	<a href="<?php echo $registerLink; ?>" target="_blank" class="button">Register</a>
<?php endif; ?>
